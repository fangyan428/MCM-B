...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.98\linewidth]{figures/fig01_overview_optimized.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.90\linewidth,trim={0 25bp 0 105bp},clip]{figures/fig06_q3_algorithm_optimized.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\linewidth,trim={0 25bp 0 170bp},clip]{figures/fig20_q4_coverage_certificate.png}
...
图15概括两组运行的时间分布：联合方案的中心位置和高耗时区间整体下降，但红色连线保留同一布局条件中的严重慢例，显示分布改进与逐例优势是两回事。

\begin{figure}[htbp]
\centering
\includegraphics[width=0.84\linewidth,trim={0 95bp 0 0},clip]{figures/fig19_q3_time_distribution_optimized.png}
...
图19概括31站初始基线与25站推荐的时间分布。箱体和高耗时观测整体下移，说明均值改进并非仅由少数极快案例造成；组件删减的均值比较则在下文单独说明。两批各96布局中，25站推荐平均时间分别为6640.86
s和6694.69
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.84\linewidth]{figures/fig14_q4_historical_optimized.png}
...
图20概括布局配对变化，定量判断采用核验后的统计值。组合的平均省时为0.366\%，95\%区间为{[}−0.183\%,
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.84\linewidth]{figures/fig15_q4_latest_optimized.png}
