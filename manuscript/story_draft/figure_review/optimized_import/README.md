...
后续图文位置调整：图12移到双环参数推导之前，图13保留在推导之后，均按正文位置嵌入；两图间穿插参数推导。局部图文间距设为6 pt，图13顶部裁边由135 bp增至170 bp，保留80%宽度。最终图12在第23页、图13在第24页，全文46页。已渲染核查两页，图13上方留白缩短，内容无裁切；21幅图编号与Markdown/LaTeX引用顺序一致，全文无越界文本。
